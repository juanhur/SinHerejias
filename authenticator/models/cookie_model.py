...
class CookieModel:
    ...
    def _token_encode(self) -> str:
        ...
        """
        return jwt.encode({'name': st.session_state['name'],"email":st.session_state['email'],"roles":st.session_state['roles'],"username":st.session_state['username'],'exp_date': self.exp_date}, self.cookie_key, algorithm='HS256')
